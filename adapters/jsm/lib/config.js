...
function loadConfig(options = {}) {
  ...
  // Cloud icon override: set ICON_ID to a known-good icon GUID to avoid
  // broken default icons in the Cloud type tree. Find icon IDs by calling
  // GET /icon/global on your instance.
  config.iconId = process.env.ICON_ID || null;
