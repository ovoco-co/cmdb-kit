...
By default, all lookup types (Application Status, Environment Type, etc.) create custom reference tables with `name` and `description` columns. This preserves descriptions and keeps the adapter logic uniform.
