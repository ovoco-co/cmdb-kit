...
The Atlassian Implementation Patterns chapter covers the exact field configuration, AQL syntax, and tiered dependency model for implementing cascading fields in JSM.
...
The Atlassian Implementation Patterns chapter provides complete automation rule configurations for each integration point.
