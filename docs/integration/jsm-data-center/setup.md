This document covers integrating CMDB-Kit with Jira, Confluence, ScriptRunner, and platform automation. For schema import and data sync, see the [platform setup documentation](../../Setup/atlassian-data-center.md).
